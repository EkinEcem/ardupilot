...
public:
    ...
    enum class Number : uint8_t {
        ...
        BMS_NOJAM =    27,  // New Bms AltHold mode 
    };
...
class ModeBms_NoJam : public Mode {

    public:
    // inherit constructor
    using Mode::Mode;
    bool init(bool ignore_checks) override;
    Number mode_number() const override { return Number::BMS_NOJAM; }
    ...
    protected:
        ...
        const char *name() const override { return "BMS_NOJAMMODE"; }
        const char *name4() const override { return "BMS_NOJAM"; }
